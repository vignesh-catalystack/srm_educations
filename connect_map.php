...
SERVER['HTTP_HOST'] ?? 'localhost';
    $mapPath = parse_url(<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
SERVER['REQUEST_URI'] ?? '/connect_map.php', PHP_URL_PATH);
    $mapCanonical = $mapScheme . '://' . $mapHost . $mapPath;
    ?>
    <link rel="canonical" href="<?php echo htmlspecialchars($mapCanonical); ?>">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Connect with SRM Education">
    <meta property="og:description" content="Find and connect with SRM Education locations, contact points, and admissions support details.">
    <meta property="og:url" content="<?php echo htmlspecialchars($mapCanonical); ?>">
    <meta property="og:image" content="<?php echo htmlspecialchars($mapScheme . '://' . $mapHost . '/assets/images/srm-main-logo.png'); ?>">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Connect with SRM Education">
    <meta name="twitter:description" content="Find and connect with SRM Education locations, contact points, and admissions support details.">
    <meta name="twitter:image" content="<?php echo htmlspecialchars($mapScheme . '://' . $mapHost . '/assets/images/srm-main-logo.png'); ?>">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root {
